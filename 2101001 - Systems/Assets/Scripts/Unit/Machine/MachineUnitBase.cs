...
public class MachineUnitBase : MonoBehaviour, GameManager.IComponentDataIOAble<MachineUnitBase.MachineUnitBaseData>
{
    #region 컴포넌트에 대한 설명

    #endregion

    public MachineUnitBaseData machineUnitBaseData;
    ...
    {
        public int ID; // 게임 매니저에 정해진 아이디 값을 여기에 집어넣습니다.
        // "MachineUnit은 고유한 기능을 가진 기계부품들의 집합입니다."
    ...
    public MachineUnitBaseData GetData()
    {
        return machineUnitBaseData;
    }
    public void SetData(MachineUnitBaseData input)
    {
        machineUnitBaseData = input;
    }
